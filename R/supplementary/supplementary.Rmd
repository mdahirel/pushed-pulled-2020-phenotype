...
Our measure of effective dispersal is the proportion of offspring $p_{m,i,j,k} = f_{m,i,j,k}/F_{m,i,j,k}$ found in the arrival patch, compared to the total number of offspring in a replicate $k$ (arrival + departure patch, $F_{m,i,j,k}$). This can be analysed using binomial models:
